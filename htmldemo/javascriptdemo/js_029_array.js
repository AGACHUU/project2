...
console.log(fruits.join('_')); //Banana _Orange_Apple_Mango

//배열의 끝에  요소 추가
fruits[4] = 'Kiwi';
console.log(fruits); //['Bannan','Orange','Apple','Mango','Kiwi']
...
console.log(arr3.flat()); //[1,3,array(1),array(2),array(2)]
